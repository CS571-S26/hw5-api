...
import { CS571DefaultPublicConfig, CS571DefaultSecretConfig, CS571Initializer, CS571InitOptions } from '@cs571/api-framework'
...
const appBundle = CS571Initializer.init<CS571DefaultPublicConfig, CS571DefaultSecretConfig>(app, new CS571InitOptions());
